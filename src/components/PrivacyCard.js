  ...
  return (
    ...
    >
      ...
      <p className="card-text">
        ...
        Aus Technischen- und Sicherheitsgründen werden vom Provider (strato.de,
        bzw. gatsby.com) von Ihnen gewisse technische Daten gespeichert. Mehr
        Details dazu erhalten Sie weiter unten. Bei Schriftverkehr behalte ich
        zur Kontaktaufnahme Ihre Kontaktdaten. Die Vertraulichkeit der von Ihnen
        bereitgestellten personenbezogenen Daten werden gewahrt und diese vor
        unbefugten Zugriffen geschützt. <br />
        <br />
        ...
        geografischen Gesichtspunkten geordnet geführt wird. <br />
        <br />
        Verantwortlicher <br />
        ...
        Die Verarbeitung personenbezogener Daten ist nur rechtmäßig, wenn für
        die Verarbeitung eine Rechtsgrundlage besteht. Rechtsgrundlage für die
        ...
        erforderlich, der der Verantwortliche unterliegt; <br />
        ...
        erfolgt, die dem Verantwortlichen übertragen wurde; <br />
        ...
        (1) Im Folgenden erhalten Sie Informationen über die Erhebung
        personenbezogener Daten bei Nutzung dieser Website. Personenbezogene
        Daten sind z.B. Name, Adresse, E-Mail-Adressen, Nutzerverhalten. <br />
        <br />
        (2) Bei einer Kontaktaufnahme per E-Mail oder über ein Kontaktformular
        werden die von Ihnen mitgeteilten Daten (Ihre E-Mail-Adresse, ggf. Ihr
        Name und Ihre Telefonnummer) gespeichert, um Ihre Fragen zu beantworten.
        Die in diesem Zusammenhang anfallenden Daten werden gelöscht, nachdem
        die Speicherung nicht mehr erforderlich ist, oder die Verarbeitung wird
        eingeschränkt, falls gesetzliche Aufbewahrungspflichten bestehen. <br />
        <br />
        ...
        nicht registrieren oder anderweitig Informationen übermitteln, erheben
        wir nur die personenbezogenen Daten, die Ihr Browser an den Server
        übermittelt. Wenn Sie diese Website betrachten möchten, erhebt der
        Provider folgende Daten, die technisch erforderlich sind, um Ihnen die
        ...
        für die Festlegung dieser Dauer; <br />
        ...
        internationale Organisation übermittelt, so haben Sie das Recht, über
        die geeigneten Garantien gemäß Artikel 46 DSGVO im Zusammenhang mit der
        Übermittlung unterrichtet zu werden. Wir stellen eine Kopie der
        personenbezogenen Daten, die Gegenstand der Verarbeitung sind, zur
        Verfügung. Für alle weiteren Kopien, die Sie Person beantragen, können
        wir ein angemessenes Entgelt auf der Grundlage der Verwaltungskosten
        verlangen. Stellen Sie den Antrag elektronisch, so sind die
        Informationen in einem gängigen elektronischen Format zur Verfügung zu
        stellen, sofern er nichts anderes angibt. Das Recht auf Erhalt einer
        Kopie gemäß Absatz 3 darf die Rechte und Freiheiten anderer Personen
        ...
        <br />
        (5) Recht auf Löschung („Recht auf vergessen werden“) Sie haben das
        ...
        Artikel 21 Absatz 2 DSGVO Widerspruch gegen die Verarbeitung ein. <br />
        ...
        unmöglich macht oder ernsthaft beeinträchtigt, oder <br />
        ...
        eines Mitgliedstaats verarbeitet. <br />
        <br />
        ...
        gemäß Artikel 6 Absatz 1 Buchstabe b DSGVO beruht und die Verarbeitung
        mithilfe automatisierter Verfahren erfolgt. Bei der Ausübung des Rechts
        auf Datenübertragbarkeit gemäß Absatz 1 haben Sie das Recht, zu
        erwirken, dass die personenbezogenen Daten direkt von einem
        Verantwortlichen zu einem anderen Verantwortlichen übermittelt werden,
        soweit dies technisch machbar ist. Die Ausübung des Rechts auf
        ...
        e oder f DSGVO erfolgt, Widerspruch einzulegen; dies gilt auch für ein
        ...
        Informationsgesellschaft könne Sie ungeachtet der Richtlinie 2002/58/EG
        Ihr Widerspruchsrecht mittels automatisierter Verfahren ausüben, bei
        ...
        <br />
        Das Widerspruchsrecht können Sie jederzeit ausüben, indem Sie sich an
        den jeweiligen Verantwortlichen wenden. <br />
        <br />
        ...
        betroffenen Person und dem Verantwortlichen erforderlich ist, <br />
        ...
        enthalten oder mit ausdrücklicher Einwilligung der betroffenen Person
        erfolgt. <br />
        ...
        sich an den jeweiligen Verantwortlichen wendet. <br />
        <br />
        ...
        ist, dass Ihre, aufgrund dieser Verordnung zustehenden Rechte, infolge
        einer nicht im Einklang mit dieser Verordnung stehenden Verarbeitung
        Ihrer personenbezogenen Daten verletzt wurden. <br />
      </p>
    </motion.div>
  );
}
