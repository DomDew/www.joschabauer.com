...
export const Navgroups = () => (
  <motion.div className="nav-animator" variants={itemVariants}>
    ...
    <motion.div variants={groupVariants} className="socials">
      <a
        className="nav-link"
        href="https://www.instagram.com/joschabauer__"
        target="_blank"
        rel="noreferrer"
      >
        instagram
      ...
      <a
        className="nav-link"
        href="https://joschabauer.bandcamp.com"
        target="_blank"
        rel="noreferrer"
      >
        bandcamp
      ...
      <a
        className="nav-link"
        href="https://www.vimeo.com/joschabauer"
        target="_blank"
        rel="noreferrer"
      >
        vimeo
    ...
    <motion.div variants={groupVariants} className="contact">
      <a className="nav-link" href="mailto:info@joschabauer.com">
        contact
      </a>
    </motion.div>
